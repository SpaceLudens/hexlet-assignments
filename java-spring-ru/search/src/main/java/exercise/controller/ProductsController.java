...
public class ProductsController {
    ...
    public List<ProductDTO> index(
        ...
        var spec = productSpecification.build(params); // Создание спецификации
        var pageable = PageRequest.of(page - 1, 10); // Пагинация по 10 товаров на страницу
        var productsPage = productRepository.findAll(spec, pageable); // Получение товаров с фильтрацией

        return productsPage
                .map(productMapper::map) // Преобразование сущностей в DTO
